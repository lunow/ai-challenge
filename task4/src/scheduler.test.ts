...
import { AirportConfig, Flight } from './types.js';
import { scheduleAirport, analyzeBottlenecks, addMinutes, diffMinutes } from './scheduler.js';
import { validateConfig } from './config.js';

const mockConfig: AirportConfig = {
  runwayCount: 2,
  gateCount: 2,
  groundCrewCount: 2,
...
describe('ATC Scheduler & Configuration Tests', () => {
  ...
  describe('Scheduling Logic', () => {
    ...
    test('handles priority reordering', () => {
      ...
      const config1Runway: AirportConfig = { ...mockConfig, runwayCount: 1 };
      const flights: Flight[] = [
        {
          flightNumber: 'LOW1',
          operationType: 'arrival',
